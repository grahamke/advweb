...
var arr1 = [{name: 'Elie'}, {name: 'Tim'}, {name: 'Matt'}, {name: 'Colt'}]
console.log(extractValue(arr1,'name')); // ['Elie', 'Tim', 'Matt', 'Colt']
...
console.log(addKeyAndValue(arr2, 'title', 'Instructor')); // [ {title: 'Instructor', name: 'Elie'}, {title: 'Instructor', name: 'Tim'}, {title: 'Instructor', name: 'Matt'}, {title: 'Instructor', name: 'Colt'} ]
