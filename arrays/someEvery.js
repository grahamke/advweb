...
console.log(hasCertainKey(arrKeys,'first')); // true
console.log(hasCertainKey(arrKeys,'isCatOwner')); // false
...
console.log(hasCertainValue(arrVal,'title','Instructor')); // true
console.log(hasCertainValue(arrVal,'first','Elie')); // false
