...
console.log(tripleAndFilter([2, 5, 10]));
...
console.log(doubleOddNumbers([1, 2, 3]));
...
console.log(mapFilterAndReduce([{firstName: "Kevin"},{firstName: "Tim"},{firstName: "Hy"}]));
...
var createStudentObj = (first, last) => ( {firstName: first, lastName: last} );
